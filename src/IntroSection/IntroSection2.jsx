      ...
      if (!shoe.current) return;  // Ensure the model is loaded
        ...
        .to("#container3D", {
          ...
          width:30,
           opacity: 0,
          scrollTrigger: {
            trigger: "#description",  // Trigger when this element enters the viewport
            start: "top 90%",        // Start when 80% of the element is visible
            end: "center bottom",          // End when 20% of the element is visible
            scrub: true,            
          },     onComplete: () => {
