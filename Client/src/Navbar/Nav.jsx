        ...
        <header className="absolute top-1/2 w-full -translate-y-1/2">
          <nav className="flex w-full items-center justify-between px-4 py-2">
            ...
            <div className=" nav hidden md:flex items-center gap-8">
              ...
              <Link to="/men" className="nav-link hover:text-violet-600  hover:border-b-2 hover:border-slate-700">Men</Link>
              <Link to="/women" className="nav-link hover:text-violet-600  hover:border-b-2 hover:border-slate-700">Women</Link>
              <Link to="/kids" className="nav-link hover:text-violet-600  hover:border-b-2 hover:border-slate-700">Kids</Link>
