  ...
  async function uploadImageToCloudinary() {
    ...
    try {
      ...
      if (response?.data?.success && response?.data?.result?.url) {
        ...
        console.error("Image upload failed:", response?.data?.message || "No URL found in response.");
      }
    } catch (error) {
    ...
    >
      ...
      >
        ...
        {!imageFile ? (
          ...
          >
            <UploadCloudIcon className="w-10 h-10 text-muted-foreground text-black mb-2" />
